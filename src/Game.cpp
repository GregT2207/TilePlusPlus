...
void Game::createGameObjects()
{
    ...
    player->addComponent<SpriteRenderer>(renderer, resourceManager, "sprites/player.png");
    ...
    enemy->addComponent<SpriteRenderer>(renderer, resourceManager, "sprites/enemy.png");
